...
// - protoc             v4.25.1
// source: quiz/quizzes/quiz_service.proto
...
const (
	...
	Quizzes_Delete_FullMethodName             = "/quizzes.Quizzes/Delete"
	Quizzes_Create_FullMethodName             = "/quizzes.Quizzes/Create"
	Quizzes_ListScoresByQuizId_FullMethodName = "/quizzes.Quizzes/ListScoresByQuizId"
)
...
type QuizzesClient interface {
	...
	Create(ctx context.Context, in *QuizCreateInput, opts ...grpc.CallOption) (*Quiz, error)
	ListScoresByQuizId(ctx context.Context, in *Id, opts ...grpc.CallOption) (*QuizScoreList, error)
}
...
func (c *quizzesClient) Delete(ctx context.Context, in *Id, opts ...grpc.CallOption) (*BoolMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolMessage)
	err := c.cc.Invoke(ctx, Quizzes_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quizzesClient) Create(ctx context.Context, in *QuizCreateInput, opts ...grpc.CallOption) (*Quiz, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Quiz)
	err := c.cc.Invoke(ctx, Quizzes_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quizzesClient) ListScoresByQuizId(ctx context.Context, in *Id, opts ...grpc.CallOption) (*QuizScoreList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QuizScoreList)
	err := c.cc.Invoke(ctx, Quizzes_ListScoresByQuizId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QuizzesServer interface {
	...
	Create(context.Context, *QuizCreateInput) (*Quiz, error)
	ListScoresByQuizId(context.Context, *Id) (*QuizScoreList, error)
}

// UnimplementedQuizzesServer should be embedded to have
...
func (UnimplementedQuizzesServer) GetResultQuiz(context.Context, *GetResultQuizInput) (*QuizAnswer, error) {
	return nil, status.Error(codes.Unimplemented, "method GetResultQuiz not implemented")
}
func (UnimplementedQuizzesServer) Delete(context.Context, *Id) (*BoolMessage, error) {
	return nil, status.Error(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedQuizzesServer) Create(context.Context, *QuizCreateInput) (*Quiz, error) {
	return nil, status.Error(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedQuizzesServer) ListScoresByQuizId(context.Context, *Id) (*QuizScoreList, error) {
	return nil, status.Error(codes.Unimplemented, "method ListScoresByQuizId not implemented")
}
...
func RegisterQuizzesServer(s grpc.ServiceRegistrar, srv QuizzesServer) {
	// If the following call panics, it indicates UnimplementedQuizzesServer was
...
func _Quizzes_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QuizzesServer).Delete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Quizzes_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuizzesServer).Delete(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}

func _Quizzes_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QuizCreateInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QuizzesServer).Create(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Quizzes_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuizzesServer).Create(ctx, req.(*QuizCreateInput))
	}
	return interceptor(ctx, in, info, handler)
}

func _Quizzes_ListScoresByQuizId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QuizzesServer).ListScoresByQuizId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Quizzes_ListScoresByQuizId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QuizzesServer).ListScoresByQuizId(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Quizzes_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Delete",
			Handler:    _Quizzes_Delete_Handler,
		},
		{
			MethodName: "Create",
			Handler:    _Quizzes_Create_Handler,
		},
		{
			MethodName: "ListScoresByQuizId",
			Handler:    _Quizzes_ListScoresByQuizId_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "quiz/quizzes/quiz_service.proto",
}
